...
describe('Forecast Service', () => {
    ...
    it('Should return the forecast for a list of beaches', async () => {
        ...
        const beachesWithRating = await forecast.processedForecastForBeaches(beaches)
        expect(beachesWithRating).toEqual(expectedResponse)
    })

    it('Should return an empty list when the beaches array is empty', async () => {
        const forecast = new Forecast()
        const response = await forecast.processedForecastForBeaches([])
    ...
    it('Should throw internal processing error when something goes wrong during the rating process', async () => {
        ...
        await expect(forecast.processedForecastForBeaches(beaches)).rejects.toThrow(ForecastProcessingInternalError)
    })
})